...
namespace PAP3.Controllers
{
    ...
    public class PedidosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("NumPedido,Nome,DataPedido,Total,ClienteId,Localidade,Pais,CodPostal,Morada")] Pedido pedido)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("NumPedido,Nome,DataPedido,Total,ClienteId,Localidade,Pais,CodPostal,Morada")] Pedido pedido)
        {
